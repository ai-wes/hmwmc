...
from hpm_v2 import StructuredStateConfig, TypedEventLogConfig, StateCheckpointConfig
...
def build_model(world_cfg: WorldConfig, **model_config_overrides) -> Tuple[HomeostaticMultimodalWorldModel, MultimodalPredictionLoss, LatentRuleProbe]:
    ...
    cfg = WorldModelConfig(
        ...
        structured_state_config=StructuredStateConfig(
            enabled=True,
            n_entities=world_cfg.max_entities,
            d_state=96,
        ),
        typed_event_log_config=TypedEventLogConfig(
            enabled=True,
            max_events=32,
        ),
        state_checkpoint_config=StateCheckpointConfig(
            enabled=True,
            n_checkpoints=16,
        ),
        entity_table_config=None,
        event_tape_config=None,
        entity_history_config=None,
